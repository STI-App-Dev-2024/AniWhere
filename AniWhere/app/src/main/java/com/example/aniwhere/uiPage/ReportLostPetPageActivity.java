...
public class ReportLostPetPageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MaterialButton lostButton = findViewById(R.id.lostbtn);
        lostButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                recyclerView.setAdapter(lostPetAdapter);
                Toast.makeText(ReportLostPetPageActivity.this, "Showing Lost Pets", Toast.LENGTH_SHORT).show();
            }
        });
        MaterialButton foundButton = findViewById(R.id.foundbtn);
        foundButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                recyclerView.setAdapter(foundPetAdapter);
                Toast.makeText(ReportLostPetPageActivity.this, "Showing Found Pets", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(ReportLostPetPageActivity.this, ReportFoundPetPageActivity.class);
            }
        });
    }
}
